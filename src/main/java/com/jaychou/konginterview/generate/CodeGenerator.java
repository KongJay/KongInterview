package com.jaychou.konginterview.generate;
 ...
 * @from <a href="https://www.code-nav.cn">KongのBlog</a>
 */
public class CodeGenerator {
    ...
    public static void main(String[] args) throws TemplateException, IOException {
        // 指定生成参数
        String packageName = "com.jaychou.konginterview";
        String dataName = "题库题目关联";
        String dataKey = "question_bank_question";
        String upperDataKey = "Question_bank_question";
